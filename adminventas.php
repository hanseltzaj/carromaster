...
<header>
    ...
    <div class="container p-8 espacioarriba">
        <div class="row">
            <div class="container">
            <center><h2>VENTAS POR PROCESAR</h2></center>
                    ...
                    <table id="tablita" class="table table-bordered responsive">
                        ...
                        <tbody>
                            <?php
                                $query = "SELECT * FROM recibo WHERE estado='Sin Procesar'";
                                ...
                                while($row = mysqli_fetch_array($resultTask)){ 
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <center>
                                            <a href="adminproventa.php?id=<?php echo $row['idRecibo']?>" class="btn btn-secondary">
                                                Procesar
                                            </a>
                                            <a href="admindescventa.php?id=<?php echo $row['idRecibo']?>" class="btn btn-danger">
                                                Descartar
                                            </a>
                                            </center>
                                        </td>
